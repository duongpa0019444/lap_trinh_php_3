...
@endif
    <form action="{{ route('tin.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="tieuDe" value="{{ old('tieuDe') }}" name="tieuDe">
        </div>
        @error('tieuDe')
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="idLT" value="{{ old('idLT') }}" name="idLT">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="tags" value="{{ old('tags') }}" name="tags" placeholder="Nhập các tags cách nhau bởi dấu phẩy">
        </div>
        @error('tags')
        <div class="alert alert-danger">{{ $message }}</div>
    @enderror
        ...
        <div class="mb-3">
            ...
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="noiBat" value="{{ old('noiBat') }}" name="noiBat" value="1">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="anHien" value="{{ old('anHien') }}" name="anHien">
